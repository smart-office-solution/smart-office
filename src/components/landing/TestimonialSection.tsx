        ...
        >
          <div className="bg-card border border-border rounded-3xl p-8 md:p-12 shadow-lg shadow-primary/5 relative">
            ...
            <blockquote className="text-lg md:text-xl text-foreground/90 leading-relaxed text-center mb-8 italic">
              "[Testimonio del cliente — pega aquí el texto real del testimonio. Describe brevemente cómo era la situación antes, qué cambió con Smart Office IA y qué resultados concretos ha obtenido (más citas, menos llamadas, horas recuperadas…)]"
            </blockquote>
