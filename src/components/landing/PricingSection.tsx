...
const plans = [
  {
    ...
    pain: "Pierdes pacientes porque tu web no transmite confianza… y nadie responde cuando te escriben.",
    solution: "Optimizamos tu web para convertir visitas en citas, con un asistente que responde automáticamente.",
    transforms: [
      "De una web que no genera nada → a una web que capta y responde por ti",
      "De una consulta en Google a una cita agendada en minutos",
    ],
    price: "349€",
    monthly: "49€/mes",
    includes: [
  ...
  },
  {
    ...
    pain: "Pierdes horas respondiendo siempre lo mismo. Se te escapan pacientes fuera de horario.",
    solution: "Un asistente que responde, filtra y agenda citas automáticamente en web y WhatsApp.",
    transforms: [
      "De responder el 40% → a cubrir prácticamente todas las consultas",
  ...
  },
  {
    ...
    pain: "Tienes días con huecos vacíos… y pacientes que no vuelven porque nadie les recuerda.",
    solution: "Sistema para reactivar pacientes y rellenar tu agenda automáticamente.",
    transforms: [
      "Menos huecos vacíos",
      "Más ingresos sin conseguir nuevos pacientes",
      "Mejor aprovechamiento de tu agenda",
    ],
    price: "1.700€",
    monthly: "109€/mes",
    includes: [
